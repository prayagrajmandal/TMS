...
export default function GatePassPage() {
  ...
  const { gatePasses: liveGatePasses, isLoading, createGatePass, updateGatePassStatus } = useGatePasses()
  ...
  const handleStatusUpdate = (gatePassId: string, status: "Approved" | "Rejected") => {
    void updateGatePassStatus(gatePassId, status)
  ...
  const handleSubmit = () => {
    ...
    setShowForm(false)
    setFeedback("Gate pass created successfully.")
  }
